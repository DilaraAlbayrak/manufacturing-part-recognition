## https://github.com/RBirkeland/MVCNN-PyTorch/blob/master/controller.py
...
parser.add_argument('--epochs', default=40, type=int, metavar='N', help='number of total epochs to run (default: 100)')
...
parser.add_argument('-r', '--resume', default='checkpoint/resnet18_checkpoint.pth.tar', type=str, metavar='PATH',
...
# normalize = transforms.Normalize(mean=[0.964, 0.964, 0.964],
#                                     std=[0.153, 0.153, 0.153])
...
# Helper functions
def load_checkpoint():
    global best_acc, best_loss, start_epoch
    # Load checkpoint.
    print('\n==> Loading checkpoint..')
    ...
    # Load the pre-trained model, whh as old_num_classes
